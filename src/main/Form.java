...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        minimisationRadioButton.setText("Minimsation");
        ...
        this.$$$loadButtonText$$$(annulerButton, ResourceBundle.getBundle("strings").getString(""));
        panel2.add(annulerButton);
        validerButton = new JButton();
        this.$$$loadButtonText$$$(validerButton, ResourceBundle.getBundle("strings").getString(""));
        panel2.add(validerButton);
        final JLabel label4 = new JLabel();
        label4.setText("Tours actuels");
